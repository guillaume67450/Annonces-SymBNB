...
class AccountController extends AbstractController
{
    ...
    public function updatePassword(Request $request, UserPasswordEncoderInterface $encoder, EntityManagerInterface $manager) {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            // 1. Vérifier que le oldPassword soit le même que le password (dans la BD) de l'utilisateur
            // on utilise la fonction password verify, qui prend l'arguement du mot de passe en clair en premier paramètre, et le hash tel que dans la BD en 2é paramètre
