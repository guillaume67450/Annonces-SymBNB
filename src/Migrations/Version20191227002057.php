 ...
 */
final class Version20191227002057 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE image ADD ad_id INT NOT NULL, ADD url VARCHAR(255) NOT NULL, ADD caption VARCHAR(255) NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE image DROP ad_id, DROP url, DROP caption');
    }
}
