...
class Ad
{
    ...
    public function getAvgRatings() {
        ...
        // on va réduire le tableau à une seule valeur : la méthode toArray transforme l'ArrayCollection en un tableau
        // ensuite la fonction recevra 2 variables qui sont calculées
